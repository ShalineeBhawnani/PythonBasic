...
from chat.token import token_activation,token_validation,account_activation_token
from rest_framework.response import Response
from chat.serializers import EmailSerializer,LoginSerializer, RegistrationSerializer, UserSerializer
